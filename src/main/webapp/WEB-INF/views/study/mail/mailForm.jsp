  ...
  <script>
  	...
  	function jusorokView() {
			$("#myModal").on("show.bs.modal", function(e) {
				...
				let jusorok = '<table class="table table-hover">';
  ...
  <form name="myform" method="post">
  	<table class="table table-borderd">
  		<tr>
  			...
  			<td>
  				<div class="row">
	  				<div class="col"><input type="text" name="toMail" value="${email}" placeholder="받는사람 메일주소를 입력하세요." class="form-control" required /></div>
	  				<div class="col"><input type="button" value="주소록" onclick="jusorokView()" class="btn btn-info form-control" data-toggle="modal" data-target="#myModal" /></div>
  				</div>
  			</td>
  		</tr>
  		<tr>
	...
	<div class="modal-dialog">
		<div class="modal-content" style="width:600px;">
			<div class="modal-header" style="width:600px;">
				<h4 class="modal-titile">☆ 주 소 록 ☆(건수:<span id="cnt"></span>)</h4>
