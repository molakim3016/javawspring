...
<div class="container">
  ...
  <p>
  	- 스프링 시큐리티(Spring Security) 프레임워크에서 제공하는 클래스중 하나로 비밀번호를 암호화 하는데 사용함.<br/>
    	&nbsp;&nbsp;자바 서버개발을 위해 필요한 인증/권한부여 및 기타 보안기능을 제공해주는 프래임워크이다.<br/><br/>
    - BCryptPasswordEncoder는 BCrypt해싱함수(BCrypt hashing function)를 사용하여 비밀번호를 인코딩해주는 메서드와
    	사용자에 의해 제출된 비밀번호와 저장소에 저장된 비밀번호의 일치여부를 확인해주는 메서드를 제공한다.<br/><br/>
    - PasswordEncoder 인터페이스를 구현한 클래스이다.<br/><br/>
    - encode(java.lang.CharSequence) :<br/>
      &nbsp;&nbsp;패스워드 암호화 해주는 메소드이다. 반환타입은 String이다.<br/>
      &nbsp;&nbsp;encode()메서드는 sha-1, 8바이트로 결합된 해시키를 랜덤하게 생성된 솔트(salt)를 지원한다.<br/><br/>
