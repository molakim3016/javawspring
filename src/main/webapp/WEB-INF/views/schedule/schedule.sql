...
insert into schedule2 values (default,'hkd1234','2023-01-13','모임','초등 동장회, 장소:충북대사거리 카페, 시간:13시');
...
insert into schedule2 values (default,'hkd1234','2023-01-24','학습','프로젝트 설계서 제출');
insert into schedule2 values (default,'hkd1234','2023-02-12','학습','프로젝트 중간점검');
insert into schedule2 values (default,'kms1234','2023-01-13','기타','집안청소하기');
...
select * from schedule2 where mid='hkd1234' and date_format(sDate, '%Y-%m-%d')='2023-1-23';


update schedule2 set part='기타', content='계획세울 계획' where idx=15;
