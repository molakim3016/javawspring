...
desc board2;
insert into board2 values (default,'관 리맨','게시판 서비스를 시작합니다.','cjsk1126@naver.com','cjsk1126.tistory.com','이곳은 게시판입니다.',default,'192.168.50.20',default,default,'admin');
...
create table boardReply2 (
  ...
  content  text not null,							/* 댓글 내용 */
 	level int not null default 0,				/* 댓글 레벨 - 첫번째댓글(부모댓글)의 레벨은 0번 */
...
select * board where mid like '%홍%'; 홍%  %홍
홍길동 박홍자 자박홍
select * from board2 where title like '%%';
